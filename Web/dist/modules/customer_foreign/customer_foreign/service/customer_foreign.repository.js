...
exports.CustomerForeignRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../../prisma/prisma.service");
let CustomerForeignRepository = class CustomerForeignRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(data) {
...
exports.CustomerForeignRepository = CustomerForeignRepository;
exports.CustomerForeignRepository = CustomerForeignRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], CustomerForeignRepository);
//# sourceMappingURL=customer_foreign.repository.js.map